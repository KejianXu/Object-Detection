...
for page in range(1,200):
    url = f'https://image.baidu.com/search/acjson?tn=resultjson_com&logid=11725091983539592964&ipn=rj&ct=201326592&is=&fp=result&fr=&word=%E5%BA%97%E5%A4%96%E5%8D%A0%E9%81%93%E7%BB%8F%E8%90%A5&queryWord=%E5%BA%97%E5%A4%96%E5%8D%A0%E9%81%93%E7%BB%8F%E8%90%A5&cl=2&lm=-1&ie=utf-8&oe=utf-8&adpicid=&st=-1&z=&ic=0&hd=&latest=&copyright=&s=&se=&tab=&width=&height=&face=0&istype=2&qc=&nc=1&expermode=&nojc=&isAsync=&pn={page*30}&rn=30&gsm=d2&1714959178011='
    ...
    for data in datalist[:-1]:
        ...
        with open(f'../dataset/data/{num}.jpg', "wb") as f:
            f.write(img_data)
            num += 1
            if num == 201:
                sys.exit()
